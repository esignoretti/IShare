...
- [x] **CONF-01**: User can configure S3 credentials (endpoint URL, access key, secret key, bucket name)
- [x] **CONF-02**: App auto-creates the bucket if it doesn't exist
- [x] **SHAR-01**: User can share files via Finder Quick Actions menu
- [x] **SHAR-02**: Directories are compressed to a single zip file before upload
- [x] **SHAR-03**: Single files optionally compress with zip before upload
- [x] **SHAR-04**: User selects share duration (1h, 1d, 7d, 1m, forever)
- [x] **SHAR-05**: User can optionally encrypt the file with a password before upload
- [x] **SHAR-06**: User can optionally enter recipient name, email, and personal message
- [x] **SHAR-07**: File is uploaded to S3 under a duration-based prefix
- [x] **SHAR-08**: A pre-signed URL is generated, copied to clipboard
- [x] **SHAR-09**: S3 lifecycle rules auto-delete files after expiration
- [x] **SHAR-10**: System mail app opens with pre-composed draft (URL, expiry, sender's message)
- [x] **TRAY-01**: Menu bar icon shows list of all shared files
- [x] **TRAY-02**: Each entry shows filename, duration, remaining time, copy-link button, and delete button
- [x] **TRAY-03**: Shared file list persists across app restarts
- [x] **DIST-01**: App is distributed as a .dmg
